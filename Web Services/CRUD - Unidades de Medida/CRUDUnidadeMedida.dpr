...
begin
  THorse.group.Prefix('v1')
    ...
    .Get('/unidademedida',TControllerUnidadeMedida.GetUnidadesMedida)
    ...
    .Delete('/unidademedida/:id', TControllerUnidadeMedida.DeleteUnidadeMedidas);
end;
