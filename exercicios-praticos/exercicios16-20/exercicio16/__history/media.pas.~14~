...
begin
  ...
  if xmedia > 6 then
    label_resultado.Caption := xnome + ' a sua média é: ' + FormatFloat('#,##0.00', xmedia) + ' você foi aprovado'
  else
    label_resultado.Caption := xnome + ' a sua média é: ' + FormatFloat('#,##0.00', xmedia) + ' você não foi aprovado';
end;
