...
begin
  ...
  if xNumero > 80 then
    ShowMessage('O número inserido é maior que 80')

  else if xNumero < 25 then
    ShowMessage('O número inserido é menor que 25')

  else if xNumero = 40 then
    ShowMessage('O número inserido é igual a 40')
  else
    ShowMessage('Tente outro número');
end;
