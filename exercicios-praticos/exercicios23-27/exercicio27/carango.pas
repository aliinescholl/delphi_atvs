...
begin
  ...
  begin
    ...
    xCarro.Preco := STrToFloat(inputbox('Informar', 'Qual o preço do carro?', ''));
...
begin
  ...
  for i := 0 to Length(Fcarro) - 1 do
    begin
      ...
      begin
          ...
          lista_desconto.Lines.Add('O carro ' + xCarro.Modelo + ' do ano '
                                    + xCarro.combustivel + ' ficará com o preço R$'
   ...
   lista_desconto.Lines.Add('Há ' + IntToStr(xcont) + IntToStr(Length(Fcarro)) + ' no total' );
end;
