...
{===============BOTÕES COM SUAS FUNÇÕES PARA O CLIQUE===================}
...
begin
  ...
  ShowMessage(
      Format('Total do caixa é de' + #13#10 + 'R$ %d' + ',00',[xNum1]));

  ShowMessage(
      Format('Olá %s, seu saldo é ' + #13#10 + 'R$ %f', ['Aline', xNum2]))
end;
...
begin
  ...
  //ShowMessage(xNomeSobrenome) também funciona
...
begin
  ...
  NewMessage('Algo Deu errado', 'ATENÇÃO');
  NewMessage('Olá', 'Mensagem', '--');
end;
